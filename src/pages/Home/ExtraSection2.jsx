      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-2">Connecting you with local causes that need your help the most.</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <FaGlobe className="text-4xl text-pink-500 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold">Global Impact</h3>
            <p className="text-gray-600 dark:text-gray-300 mt-2">Making a difference beyond borders, one volunteer at a time.</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <FaUsers className="text-4xl text-pink-500 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold">Empowering People</h3>
            <p className="text-gray-600 dark:text-gray-300 mt-2">Giving you the tools and platform to become a force for good.</p>
          </div>
        </div>
      </div>
    </section>
